...
export default function BarberPersonalPage() {
  ...
  function saveChanges(smail, sphone) {
    const phoneflag = checkIfPhone(sphone);
    const mailflag = checkIfEmail(smail);
    ...
    <div className="mainBox">
      ...
      <div className="MiddleBox">
        ...
        <div className="dataBox">
          ...
          <button type="button" id="editButton" onClick={() => setNameState(!nameState)}>
            {' '}
            Edit
          </button>
        </div>
        ...
        <div className="dataBox">
          ...
          <button type="button" id="editButton" onClick={() => setPhoneState(!phoneState)}>
            {' '}
            Edit
          </button>
        </div>
        <div className="dataBox">
          ...
          <button type="button" id="editButton" onClick={() => setMailState(!mailState)}>
            {' '}
            Edit
          </button>
        </div>
        <div className="dataBox">
          ...
          <button type="button" id="editButton" onClick={() => setHouersState(!HouersState)}>
            {' '}
            Edit
          </button>
        </div>
        <button type="button" id="okButton" onClick={() => saveChanges(mail, phone)}>
          {' '}
          Save Changes
          {' '}
        </button>
